// src/engine/assets/json/json.cpp
...
namespace wz::engine::assets
{
    ...
    wz::asset::ResourceHandle JSONTable::add(JSONData data)
    {
        ...
        return wz::asset::ResourceHandle{
            .id = id,
            .epoch = slot.epoch,
            .type = kAssetTypeJSONDocument,
        };
    }

    const JSONData* JSONTable::get(wz::asset::ResourceHandle handle) const
    {
        ...
        if (handle.type != kAssetTypeJSONDocument)
            return nullptr;

        return &slot.data;
    }

    void JSONTable::destroy()
    {
        slots_.clear();
